        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-lg font-bold text-white">Anban</span>
            </div>
            <p className="text-sm">Kanban for humans and AI agents.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="https://github.com/gibtang/anban" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">GitHub</a></li>
              <li><a href="https://github.com/gibtang/anban/issues" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Issues</a></li>
              <li><a href="https://github.com/gibtang/anban/discussions" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Discussions</a></li>
            </ul>
          </div>
